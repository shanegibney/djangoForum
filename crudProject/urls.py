...
urlpatterns = [
    ...
    url(r'^forum/(?P<categ>[\w\-]+)/$', home.forum, name='forum'),
    # url(r'^forum/(?P<id>\d+)/$', home.forum, name='forum'),
    url(r'^info/$', home.info, name='info'),
    url(r'^temp/$', home.temp, name='temp'),
    ...
    url(r'^blog/(?P<categ>[\w\-]+)/$', home.blog, name='blog'),
    url(r'^file_sharing/(?P<categ>[\w\-]+)/$', fileshare.file_sharing, name='file_sharing'),
